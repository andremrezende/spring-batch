...
CREATE UNIQUE INDEX cliente_produto_idx ON interesse_produto_cliente (cliente, produto);
...
INSERT INTO produto (id, nome, descricao, preco) VALUES (4, 'ut', 'Im sure _I_ shant be beheaded! said Alice, who felt ready to agree to everything that was sitting on a branch of a tree in the same thing as \"I get what I say--thats the same thing a bit! said.', '16272.3');
INSERT INTO produto (id, nome, descricao, preco) VALUES (5, 'rerum', 'Then she went out, but it said nothing. This here young lady, said the Cat: were all mad here. Im mad. Youre mad. How do you know what \"it\" means well enough, when I got up and bawled out,.', '30551600');
INSERT INTO produto (id, nome, descricao, preco) VALUES (6, 'repellat', 'Pat, whats that in about half no time! Take your choice! The Duchess took no notice of her voice, and the moment she quite forgot how to spell stupid, and that makes them sour--and camomile that.', '39.57');
INSERT INTO produto (id, nome, descricao, preco) VALUES (7, 'quo', 'HER ONE, THEY GAVE HIM TWO--\" why, that must be getting home; the night-air doesnt suit my throat! and a long tail, certainly, said Alice very politely; but she did not like to show you! A little.', '9072.88');
