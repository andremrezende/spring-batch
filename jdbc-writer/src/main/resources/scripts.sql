...
CREATE TYPE tipos AS ENUM ('PRATA','OURO','PLATINA','DIAMANTE');
...
INSERT INTO cliente (nome, idade, email, faixa_salarial) VALUES ('Maxie OReilly III', 62, 'garrison.larson@example.com', '634.82');
